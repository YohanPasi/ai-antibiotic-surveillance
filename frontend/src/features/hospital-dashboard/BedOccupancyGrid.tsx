// BedOccupancyGrid.tsx - Component for Surveillance System
...
export const BedOccupancyGrid: React.FC = () => {
  // State definitions
  ...
  return (
    <div className="dashboard-widget-container">
      <h1>BedOccupancyGrid Analysis Panel</h1>
...
export default BedOccupancyGrid;